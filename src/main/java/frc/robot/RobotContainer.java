...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    m_driverController.b().whileTrue(teleopCommands.pivotCommand());
    ...
    m_driverController.b().onTrue(teleopCommands.minMaxCommand());
    ...
    m_driverController.b().onTrue(teleopCommands.printMoveCommand());
  }
}
